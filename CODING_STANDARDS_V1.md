# C Coding Standards (ARCHIVED — superseded)

> **Archived 2026-07-10.** This is the original standards doc, kept for
> history. It described a style gstr.h never followed (it mandated
> no-abbreviation names while the public API is `gstrlen`/`n_len`, etc.).
> The active standard is [CODING_STANDARDS.md](CODING_STANDARDS.md).
