 ...
 *
 * test_unicode_punct.c - Tests for gstr_is_unicode_punct_or_symbol and
...
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0021),
		  1); /* ! Po, first range start */
}

TEST(ascii_slash)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x002F),
		  1); /* / Po, first range end */
}

TEST(ascii_colon)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x003A),
		  1); /* : Po, second range start */
}

TEST(ascii_at_sign)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0040),
		  1); /* @ Po, second range end */
}

TEST(ascii_open_bracket)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x005B),
		  1); /* [ Ps, third range start */
}

TEST(ascii_backtick)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0060),
		  1); /* ` Sk, third range end */
}

TEST(ascii_open_brace)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x007B),
		  1); /* { Ps, fourth range start */
}

TEST(ascii_tilde)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x007E),
		  1); /* ~ Sm, fourth range end */
}

TEST(ascii_dollar)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0024), 1); /* $ Sc */
}

TEST(ascii_plus)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x002B), 1); /* + Sm */
}

TEST(ascii_less_than)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x003C), 1); /* < Sm */
}

TEST(ascii_equals)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x003D), 1); /* = Sm */
}

TEST(ascii_greater_than)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x003E), 1); /* > Sm */
}

TEST(ascii_caret)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x005E), 1); /* ^ Sk */
}

TEST(ascii_pipe)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x007C), 1); /* | Sm */
}
...
TEST(ascii_space)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0020),
		  0); /* Below first range */
}

TEST(ascii_nul)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0000), 0); /* Edge case */
}

TEST(ascii_digit_0)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0030),
		  0); /* Between range 1-2 */
}

TEST(ascii_letter_A)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0041),
		  0); /* Between range 2-3 */
}

TEST(ascii_letter_a)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0061),
		  0); /* Between range 3-4 */
}

TEST(ascii_del)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x007F),
		  0); /* Above last range */
}
...
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0039),
		  0); /* '9', just before ':' */
}

TEST(ascii_before_range3)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x005A),
		  0); /* 'Z', just before '[' */
}

TEST(ascii_before_range4)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x007A),
		  0); /* 'z', just before '{' */
}
...
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0080),
		  0); /* Cc, binary search path */
}
...
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00A1), 1); /* ¡ Po */
}

TEST(unicode_section_sign)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00A7), 1); /* § Po */
}

TEST(unicode_left_guillemet)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00AB), 1); /* « Pi */
}

TEST(unicode_right_guillemet)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00BB), 1); /* » Pf */
}

TEST(unicode_en_dash)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x2013), 1); /* – Pd */
}

TEST(unicode_em_dash)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x2014), 1); /* — Pd */
}

TEST(unicode_left_single_quote)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x2018), 1); /* ' Pi */
}

TEST(unicode_right_single_quote)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x2019), 1); /* ' Pf */
}

TEST(unicode_left_double_quote)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x201C), 1); /* " Pi */
}

TEST(unicode_right_double_quote)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x201D), 1); /* " Pf */
}

TEST(unicode_dagger)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x2020), 1); /* † Po */
}

TEST(unicode_ellipsis)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x2026), 1); /* … Po */
}

TEST(unicode_fullwidth_exclamation)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0xFF01), 1); /* ！ Po */
}

TEST(unicode_fullwidth_period)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0xFF0E), 1); /* ．Po */
}

TEST(unicode_cjk_comma)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x3001), 1); /* 、 Po */
}

TEST(unicode_cjk_period)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x3002), 1); /* 。 Po */
}

TEST(unicode_left_corner_bracket)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x300C), 1); /* 「 Ps */
}
...
TEST(unicode_cent)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00A2), 1); /* ¢ Sc */
}

TEST(unicode_yen)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00A5), 1); /* ¥ Sc */
}

TEST(unicode_copyright)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00A9), 1); /* © So */
}

TEST(unicode_not_sign)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00AC), 1); /* ¬ Sm */
}

TEST(unicode_registered)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00AE), 1); /* ® So */
}

TEST(unicode_degree)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00B0), 1); /* ° So */
}

TEST(unicode_multiply)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00D7), 1); /* × Sm */
}

TEST(unicode_divide)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00F7), 1); /* ÷ Sm */
}

TEST(unicode_euro)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x20AC), 1); /* € Sc */
}

TEST(unicode_not_equal)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x2260), 1); /* ≠ Sm */
}
...
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00E4), 0); /* ä Ll */
}

TEST(unicode_cyrillic_A)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0410), 0); /* А Lu */
}

TEST(unicode_cjk_ideograph)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x4E2D), 0); /* 中 Lo */
}

TEST(unicode_arabic_alef)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0627), 0); /* ا Lo */
}

TEST(unicode_combining_acute)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0301),
		  0); /* combining acute Mn */
}

TEST(unicode_devanagari_ka)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x0915), 0); /* क Lo */
}

TEST(unicode_nb_space)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00A0), 0); /* NBSP Zs */
}

TEST(unicode_em_space)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x2003), 0); /* EM SPACE Zs */
}

TEST(unicode_line_separator)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x2028),
		  0); /* LINE SEPARATOR Zl */
}
...
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0xFFFF), 0); /* Cn */
}

TEST(boundary_replacement_char)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0xFFFD),
		  1); /* REPLACEMENT CHARACTER So */
}

TEST(boundary_surrogate_start)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0xD800), 0); /* Cs */
}

TEST(boundary_first_supplementary)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x10000),
		  0); /* LINEAR B SYLLABLE Lo */
}

TEST(boundary_max_codepoint)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x10FFFF), 0);
}

TEST(boundary_above_max)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x110000), 0);
}
...
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x10100),
		  1); /* AEGEAN WORD SEPARATOR Po */
}

TEST(supplementary_musical_symbol)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x1D100),
		  1); /* MUSICAL SYMBOL So */
}
...
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00AA), 0); /* ª Lo */
}

TEST(gap_soft_hyphen)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00AD),
		  0); /* Cf (soft hyphen) */
}

TEST(gap_micro_sign)
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x00B5), 0); /* µ Ll */
}
...
{
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0x110000), 0);
	ASSERT_EQ(gstr_is_unicode_punct_or_symbol(0xFFFFFFFF), 0);
}
...
TEST(ascii_exhaustive)
{
	for (uint32_t cp = 0; cp < 0x80; cp++) {
		int expected = (cp >= 0x21 && cp <= 0x2F) ||
			       ...
			       (cp >= 0x5B && cp <= 0x60) ||
			       (cp >= 0x7B && cp <= 0x7E);
		ASSERT_EQ(gstr_is_unicode_punct_or_symbol(cp), expected);
	}
}
...
TEST(ispunct_compatibility)
{
	for (int cp = 1; cp < 128; cp++) {
		...
		ASSERT_EQ(gstr_is_unicode_punct_or_symbol((uint32_t)cp),
			  c_result);
	}
}
...
{
	for (uint32_t cp = 0; cp < 0x80; cp++) {
		int fast = gstr_is_unicode_punct_or_symbol(cp);
		int table =
			unicode_range_contains(cp, UNICODE_PUNCT_SYMBOL_RANGES,
...
TEST(whitespace_punct_mutual_exclusion)
{
	...
	for (size_t i = 0; i < sizeof(ws) / sizeof(ws[0]); i++) {
		ASSERT_EQ(gstr_is_unicode_punct_or_symbol(ws[i]), 0);
	}
}
...
TEST(whitespace_cp_matches_grapheme_variant)
{
	...
	uint32_t ws[] = {0x0009, 0x000A, 0x000B, 0x000C, 0x000D, 0x0020, 0x0085,
