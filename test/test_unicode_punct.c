...
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x0021),
		  1); /* ! Po, first range start */
}

TEST(ascii_slash)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x002F),
		  1); /* / Po, first range end */
}

TEST(ascii_colon)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x003A),
		  1); /* : Po, second range start */
}

TEST(ascii_at_sign)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x0040),
		  1); /* @ Po, second range end */
}

TEST(ascii_open_bracket)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x005B),
		  1); /* [ Ps, third range start */
}

TEST(ascii_backtick)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x0060),
		  1); /* ` Sk, third range end */
}

TEST(ascii_open_brace)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x007B),
		  1); /* { Ps, fourth range start */
}

TEST(ascii_tilde)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x007E),
...
TEST(ascii_space)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x0020),
		  0); /* Below first range */
}
...
TEST(ascii_digit_0)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x0030),
		  0); /* Between range 1-2 */
}

TEST(ascii_letter_A)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x0041),
		  0); /* Between range 2-3 */
}

TEST(ascii_letter_a)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x0061),
		  0); /* Between range 3-4 */
}

TEST(ascii_del)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x007F),
		  0); /* Above last range */
}
...
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x0039),
		  0); /* '9', just before ':' */
}

TEST(ascii_before_range3)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x005A),
		  0); /* 'Z', just before '[' */
}

TEST(ascii_before_range4)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x007A),
		  0); /* 'z', just before '{' */
}
...
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x0080),
...
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x0301),
...
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x2028),
		  0); /* LINE SEPARATOR Zl */
}
...
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0xFFFD),
...
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x10000),
...
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x10100),
		  1); /* AEGEAN WORD SEPARATOR Po */
}

TEST(supplementary_musical_symbol)
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x1D100),
		  1); /* MUSICAL SYMBOL So */
}
...
{
	ASSERT_EQ(gstr_is_unicode_punctuation(0x00AD),
		  0); /* Cf (soft hyphen) */
}
