...
{
	ASSERT_EQ(is_grapheme_break(GCB_CONTROL, GCB_EXTEND, 0, 0, 0x0300, 0),
		  1);
}
...
{
	ASSERT_EQ(is_grapheme_break(GCB_EXTEND, GCB_EXTEND, 0, 0, 0x0300, 0),
		  0);
}
...
{
	ASSERT_EQ(is_grapheme_break(GCB_EXTEND, GCB_SPACING_MARK, 0, 0, 0x0903,
				    0),
		  0);
}
...
TEST(gb9b_prepend_no_break)
{
   ...
   * executes GB9b's return, not GB9's. */
	ASSERT_EQ(is_grapheme_break(GCB_PREPEND, GCB_OTHER, 0, 0, 0x0041, 0),
		  0);
}
...
TEST(gb12_ri_odd_no_break)
{
	...
	ASSERT_EQ(is_grapheme_break(GCB_REGIONAL_INDICATOR,
				    GCB_REGIONAL_INDICATOR, 1, 0, 0x1F1FA, 0),
		  0);
}
...
TEST(gb13_ri_even_break)
{
	...
	ASSERT_EQ(is_grapheme_break(GCB_REGIONAL_INDICATOR,
				    GCB_REGIONAL_INDICATOR, 2, 0, 0x1F1FA, 0),
		  1);
}
...
TEST(gb12_ri_not_prev)
{
	...
	ASSERT_EQ(is_grapheme_break(GCB_OTHER, GCB_REGIONAL_INDICATOR, 0, 0,
				    0x1F1FA, 0),
		  1);
}
...
TEST(gb12_ri_not_curr)
{
	...
	ASSERT_EQ(is_grapheme_break(GCB_REGIONAL_INDICATOR, GCB_OTHER, 1, 0,
				    0x0041, 0),
		  1);
}
