...
/*
 * East_Asian_Width W/F character ranges (Unicode 17.0).
...
/*
 * Extended_Pictographic character ranges (Unicode 17.0).
 * Used for grapheme cluster break rule GB11 (ZWJ sequences).
...
/* GCB property ranges (Unicode 17.0, non-overlapping).
