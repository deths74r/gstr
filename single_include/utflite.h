...
#define UTFLITE__ZERO_WIDTH_COUNT                                              \
  (sizeof(UTFLITE__ZERO_WIDTH_RANGES) / sizeof(UTFLITE__ZERO_WIDTH_RANGES[0]))
...
static const struct utflite__unicode_range UTFLITE__DOUBLE_WIDTH_RANGES[] = {
    ...
    {0x2626, 0x2626},   {0x262A, 0x262A},   {0x262E, 0x263A},
    ...
    {0x268A, 0x268F},   {0x2692, 0x2697},   {0x2699, 0x2699},
    ...
    {0x2FF0, 0x303E},   {0x3041, 0x3096},   {0x309B, 0x30FF},
    {0x3105, 0x312F},   {0x3131, 0x318E},   {0x3190, 0x31E5},
    {0x31EF, 0x321E},   {0x3220, 0x3247},   {0x3250, 0xA48C},
    {0xA490, 0xA4C6},   {0xA960, 0xA97C},   {0xAC00, 0xD7A3},
    {0xF900, 0xFAFF},   {0xFE10, 0xFE19},   {0xFE30, 0xFE52},
    {0xFE54, 0xFE66},   {0xFE68, 0xFE6B},   {0xFF01, 0xFF60},
    {0xFFE0, 0xFFE6},   {0x16FE0, 0x16FE4}, {0x16FF0, 0x16FF6},
...
#define UTFLITE__DOUBLE_WIDTH_COUNT                                            \
  (sizeof(UTFLITE__DOUBLE_WIDTH_RANGES) /                                      \
   sizeof(UTFLITE__DOUBLE_WIDTH_RANGES[0]))
...
#define UTFLITE__GCB_RANGE_COUNT                                               \
  (sizeof(UTFLITE__GCB_RANGES) / sizeof(UTFLITE__GCB_RANGES[0]))
...
#define UTFLITE__INCB_LINKER_COUNT                                             \
  (sizeof(UTFLITE__INCB_LINKERS) / sizeof(UTFLITE__INCB_LINKERS[0]))
...
static const struct utflite__unicode_range UTFLITE__INCB_CONSONANTS[] = {
    ...
    {0x09F0, 0x09F1},   {0x0A15, 0x0A28},   {0x0A2A, 0x0A30},
    ...
    {0x0AB5, 0x0AB9},   {0x0AE0, 0x0AE1},   {0x0B15, 0x0B28},
    {0x0B2A, 0x0B30},   {0x0B32, 0x0B33},   {0x0B35, 0x0B39},
    {0x0B5C, 0x0B5D},   {0x0B5F, 0x0B61},   {0x0B71, 0x0B71},
    {0x0B95, 0x0B95},   {0x0B99, 0x0B9A},   {0x0B9C, 0x0B9C},
    {0x0B9E, 0x0B9F},   {0x0BA3, 0x0BA4},   {0x0BA8, 0x0BAA},
    {0x0BAE, 0x0BB9},   {0x0C15, 0x0C28},   {0x0C2A, 0x0C39},
    {0x0C58, 0x0C5A},   {0x0C5D, 0x0C5D},   {0x0C60, 0x0C61},
    {0x0C95, 0x0CA8},   {0x0CAA, 0x0CB3},   {0x0CB5, 0x0CB9},
    {0x0CDD, 0x0CDE},   {0x0CE0, 0x0CE1},   {0x0D15, 0x0D3A},
    {0x0D54, 0x0D56},   {0x0D5F, 0x0D61},   {0x0D7A, 0x0D7F},
    {0x1000, 0x1025},   {0x1027, 0x1027},   {0x1029, 0x102A},
    {0x1050, 0x1055},   {0x105A, 0x105D},   {0x1061, 0x1061},
    {0x1065, 0x1066},   {0x106E, 0x1070},   {0x1075, 0x1081},
    {0x108E, 0x108E},   {0x1703, 0x170C},   {0x170E, 0x1711},
    {0x1780, 0x17A2},   {0x17A5, 0x17A7},   {0x17A9, 0x17B3},
    {0x1901, 0x1922},   {0x1930, 0x1931},   {0x1950, 0x196D},
    {0x1980, 0x19A9},   {0x19C1, 0x19C7},   {0x1A00, 0x1A16},
    {0x1A20, 0x1A4C},   {0x1B05, 0x1B33},   {0x1B83, 0x1BA0},
    {0xA807, 0xA80A},   {0xA80C, 0xA822},   {0xA882, 0xA8B3},
    {0xA90A, 0xA925},   {0xA930, 0xA946},   {0xA989, 0xA98B},
    {0xA98D, 0xA9B2},   {0xAA00, 0xAA28},   {0xAA60, 0xAA6F},
    {0xAA71, 0xAA76},   {0xAAE0, 0xAAEA},   {0x10A00, 0x10A00},
    {0x10A10, 0x10A13}, {0x10A15, 0x10A17}, {0x10A19, 0x10A35},
    {0x11005, 0x11037}, {0x11071, 0x11072}, {0x11075, 0x11075},
    {0x11083, 0x110AF}, {0x11107, 0x1112B}, {0x11150, 0x11172},
    {0x11183, 0x111B2}, {0x111C1, 0x111C4}, {0x11200, 0x11211},
    {0x11213, 0x1122B}, {0x1123F, 0x11240}, {0x11284, 0x11286},
    {0x11288, 0x11288}, {0x1128A, 0x1128D}, {0x1128F, 0x1129D},
    {0x1129F, 0x112A8}, {0x11305, 0x1130C}, {0x1130F, 0x11310},
    {0x11313, 0x11328}, {0x1132A, 0x11330}, {0x11332, 0x11333},
    {0x11335, 0x11339}, {0x1135D, 0x11361}, {0x11400, 0x11434},
    {0x11447, 0x1144A}, {0x11481, 0x114AF}, {0x114C4, 0x114C5},
    {0x114C7, 0x114C7}, {0x11580, 0x115AE}, {0x115D8, 0x115DB},
    {0x11600, 0x1162F}, {0x11644, 0x11644}, {0x11680, 0x116AA},
    {0x116B8, 0x116B8}, {0x11700, 0x1171A}, {0x11800, 0x1182B},
    {0x11912, 0x11935}, {0x11937, 0x11938}, {0x119A0, 0x119A7},
    {0x119AA, 0x119D0}, {0x11A0B, 0x11A32}, {0x11A5C, 0x11A89},
...
#define UTFLITE__INCB_CONSONANT_COUNT                                          \
  (sizeof(UTFLITE__INCB_CONSONANTS) / sizeof(UTFLITE__INCB_CONSONANTS[0]))

static inline int
utflite__unicode_range_contains(uint32_t codepoint,
 ...
 * property from emoji-data.txt differs from
 * Grapheme_Cluster_Break=Extended_Pictographic used in GB11. The double-width
 * table correctly handles common emoji ZWJ sequences and passes all 766
 * official GraphemeBreakTest.txt tests.
 */
 ...
 * Consonant+Linker
 */
static int utflite__is_grapheme_break(enum utflite__gcb_property prev_prop,
                                      enum utflite__gcb_property curr_prop,
                                      int ri_count, int in_ext_pict,
                                      uint32_t curr_cp, int incb_state) {
  /* GB3: CR × LF */
  ...
  /* GB4: (Control | CR | LF) ÷ */
  if (prev_prop == UTFLITE__GCB_CONTROL || prev_prop == UTFLITE__GCB_CR ||
      prev_prop == UTFLITE__GCB_LF) {
    return 1;
  }

  /* GB5: ÷ (Control | CR | LF) */
  if (curr_prop == UTFLITE__GCB_CONTROL || curr_prop == UTFLITE__GCB_CR ||
...
int utflite_codepoint_width(uint32_t codepoint) {
  ...
  if (utflite__unicode_range_contains(codepoint, UTFLITE__ZERO_WIDTH_RANGES,
                                      UTFLITE__ZERO_WIDTH_COUNT)) {
    return 0;
  }
  if (utflite__unicode_range_contains(codepoint, UTFLITE__DOUBLE_WIDTH_RANGES,
                                      UTFLITE__DOUBLE_WIDTH_COUNT)) {
    return 2;
  }
  return 1;
...
int utflite_next_grapheme(const char *text, int length, int offset) {
  ...
  while (next_offset < length) {
    ...
    /* Check for break */
    if (utflite__is_grapheme_break(prev_prop, curr_prop, ri_count, in_ext_pict,
                                   curr_cp, incb_state)) {
      return next_offset;
    }
    ...
    if (curr_prop == UTFLITE__GCB_REGIONAL_INDICATOR) {
      ri_count++;
    } else if (curr_prop != UTFLITE__GCB_EXTEND &&
               curr_prop != UTFLITE__GCB_ZWJ) {
      ri_count = 0;
    }
...
int utflite_is_zero_width(uint32_t codepoint) {
  return utflite__unicode_range_contains(codepoint, UTFLITE__ZERO_WIDTH_RANGES,
                                         UTFLITE__ZERO_WIDTH_COUNT);
}

int utflite_is_wide(uint32_t codepoint) {
  return utflite__unicode_range_contains(
      codepoint, UTFLITE__DOUBLE_WIDTH_RANGES, UTFLITE__DOUBLE_WIDTH_COUNT);
}
